...
"link"===a.nodeName.toLowerCase()&&(a.href=p(a.href));l=b+a.outerHTML});try{f.document.head.innerHTML=l}catch(t){c(f.document.head).html(l)}f.document.body.innerHTML="<div style='background-image: url('https://amzcloudbox.amzetta.co.in/html/boltpro_webapp/assets/images/logo-l.png');margin-top:20px;' ></div><h2>"+d.title+"</h2><b><p>Name: "+ localStorage.getItem('PATIENT_NAME')+"</p><p>Gender: "+ localStorage.getItem('PATIENT_GENDER_TXT') +"</p><p>Age: "+ localStorage.getItem('PATIENT_AGE')+"</p></b><div>"+(d.messageTop||"")+"</div>"+h+"<div>"+(d.messageBottom||"")+"</div>";c(f.document.body).addClass("dt-print-view");c("img",f.document.body).each(function(b,a){a.setAttribute("src",p(a.getAttribute("src")))});g.customize&&g.customize(f,g,a);b=function(){g.autoPrint&&(f.print()/*,f.close()*/)};/*navigator.userAgent.match(/Trident\/\d.\d/)?
f.setTimeout(b,1E3):f.setTimeout(b,1E3)*/f.setTimeout(b,1E3)},title:"*",messageTop:"*",messageBottom:"",exportOptions:{},header:!0,footer:!1,autoPrint:!0,customize:null};return k.Buttons});
